...
class Converter():
    ...
    def __init__(self):
        ...
        # Celsius button
        self.to_celsius_button = Button(self.button_frame, text="To Celsius", bg="#990099", fg="#ffffff",
                                        font=("Arial", 12, "bold"), width=12)
        self.to_celsius_button.grid(row=0, column=0, padx=5, pady=5)

        # Fahrenheit button
        self.to_fahrenheit_button = Button(self.button_frame, text="To Fahrenheit", bg="#009900", fg="#ffffff",
                                        font=("Arial", 12, "bold"), width=12)
